...
/*	2. 문자형
    ...
    - 선언된길이 내에서 필요한 만큼만 데이터를 저장
    EX) 성별, 국가코드(KOR, CHI, USA 등)
    
    2) varchar(개수)
    : 가변 길이 문자열, 1 ~ 1638 바이트 (255 바이트까지만 작성 권장)
...
create table `character` (
 ...
 value ('Laptop Samasung Book 3 Pro', '전자제품', '삼성 갤럭시 북3 노트북 프로입니다. 아주 좋아요', 'example');
