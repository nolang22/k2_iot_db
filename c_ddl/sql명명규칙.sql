...
/*	1. 대소문자 구분 x
	: 일관성 있는 작성 권장
    - 소문자로 작성 후 ctrl +shift + u: (대문자로 변환)
...
# 	EX) student_id, lecture_code, product_price, member_grede

# cf) SQL 문법 (대문자 사용 권장) VS 네이밍 방식 (소문자 사용 권장)
# CREATE DATAASE example;
...
SELECT `student name` FROM `budan gigh school`;
